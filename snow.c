...
#define N         1000000              /* N customers will be served     */
#define SERVICE      20.0              /* Numebr of seconds to serve     */
#define ARRIVAL      60.0              /* Time between arrivals          */
#define CAPACITY        3
/*test*/
  ...
  int main(void)
{
  ...
  printf("   rejects ................. = %ld\n", reject);
  printf("   percent rejects ......... = %6.2f\n", ((double)reject)/(index+reject));
  printf("   Rho ..................... = %6.2f\n", ((area.service/index)/(t.last / index)));
